 ...
 *
 * PHOTOGRAPHS AND STICKERS LEFT for ink-rects.ts when stickers arrived, and
 * the seam is what each kind actually needs: a box has a card, a guessed
 * height and an invisible wrap, while the other two are four numbers. ADR-115.
 */
